...
export default function SuperAdminDashboard() {
  ...
  return (
    <div className="p-8">
      ...
      <div className="mb-6">
        <h3 className="text-lg font-semibold mb-4 text-gray-700 dark:text-gray-300">Overview</h3>
      </div>
          ...
          <CardContent>
            <div className="space-y-3">
              {expiringTrials.length > 0 ? (
                <>
                  {expiringTrials.slice(0, 3).map((company) => {
                    ...
                    return (
                      <div key={company.id} className="flex items-center justify-between p-3 border border-orange-200 dark:border-orange-900 bg-orange-50 dark:bg-orange-900/20 rounded-lg">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-muted-foreground">Trial expires in {daysLeft} days</p>
                          </div>
                        </div>
                  ...
                  {expiringTrials.length > 3 && (
                    <Link to="/super-admin/companies" className="block text-center text-sm text-primary hover:underline pt-2">
